...
return [
    ...
    */
    ...
    'auth' => [
        'oauth' => function($app) {
            // De LeagueOAuth2Provider is nog niet geüpdatet voor Laravel 4.2 en
            // de daarbijhorende "oauth2-server-laravel" package. Heb die daarom even
            // geüpdatet (paar calls veranderd)
            //$provider = new Dingo\Api\Auth\LeagueOAuth2Provider($app['oauth2-server.authorizer']);
            $provider = new \App\Providers\OAuth2Provider($app['oauth2-server.authorizer']);
